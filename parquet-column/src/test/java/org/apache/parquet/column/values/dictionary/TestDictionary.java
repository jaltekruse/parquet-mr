...
<<<<<<< HEAD:parquet-column/src/test/java/parquet/column/values/dictionary/TestDictionary.java
...
>>>>>>> master:parquet-column/src/test/java/org/apache/parquet/column/values/dictionary/TestDictionary.java
...
<<<<<<< HEAD:parquet-column/src/test/java/parquet/column/values/dictionary/TestDictionary.java
    return FallbackValuesWriter.of(dvw, new PlainValuesWriter(initialSize, new DirectByteBufferAllocator()));
=======
