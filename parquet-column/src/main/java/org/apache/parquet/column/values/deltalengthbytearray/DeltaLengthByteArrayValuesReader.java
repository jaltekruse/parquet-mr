...
public class DeltaLengthByteArrayValuesReader extends ValuesReader {
  ...
  public Binary readBytes() {
    ...
    int start = offset;
    offset = start + length;
<<<<<<< HEAD:parquet-column/src/main/java/parquet/column/values/deltalengthbytearray/DeltaLengthByteArrayValuesReader.java
    return Binary.fromByteBuffer(in, start, length);
=======
    return Binary.fromConstantByteArray(in, start, length);
>>>>>>> master:parquet-column/src/main/java/org/apache/parquet/column/values/deltalengthbytearray/DeltaLengthByteArrayValuesReader.java
  }
