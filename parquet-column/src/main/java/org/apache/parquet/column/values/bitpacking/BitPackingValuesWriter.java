...
public class BitPackingValuesWriter extends ValuesWriter {
  ...
  public void close() {
    try {
      ...
      throw new ParquetRuntimeException("Error closing output stream.", ex){
        // Should not be a common exception case, only if there is a low level I/O issue that will not
        // be recoverable.
      };
    }
  }
